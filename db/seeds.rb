...
copa_paranhos.photo.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'apartments', 'copa_paranhos', 'Foto_1.jpg')), filename: 'Copa Paranhos Foto 1.jpg')
...
copa_beach.photo.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'apartments', 'copa_beach', 'Foto_1.jpg')), filename: 'Copa Beach Foto 1.jpg')
...
copa_cupuacu.photo.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'apartments', 'copa_cupuacu', 'Foto_1.jpg')), filename: 'Copa Cupuaçu Foto 1.jpg')
...
copa_pitanga.photo.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'apartments', 'copa_pitanga', 'Foto_1.jpg')), filename: 'Copa Pitanga Foto 1.jpg')
...
copa_ieda.photo.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'apartments', 'copa_ieda', 'Foto_1.jpg')), filename: 'Copa Ieda Foto 1.jpg')
...
leblon_caja.photo.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'apartments', 'leblon_caja', 'Foto_1.jpg')), filename: 'Leblon Cajá Foto 1.jpg')
...
leblon_physalis.photo.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'apartments', 'leblon_physalis', 'Foto_1.jpg')), filename: 'Leblon Physalis Foto 1.jpg')
...
leblon_timoteo.photo.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'apartments', 'leblon_timoteo', 'Foto_1.jpg')), filename: 'Leblon Physalis Foto 1.jpg')
...
ipanema_jangadeiro.photo.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'apartments', 'ipanema_jangadeiro', 'Foto_1.jpg')), filename: 'Ipanema Jangadeiro Foto 1.jpg')
...
ipanema_cupuacu.photo.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'apartments', 'ipanema_cupuacu', 'Foto_1.jpg')), filename: 'Ipanema Cupuaçu Foto 1.jpg')
...
botafogo_real.photo.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'apartments', 'botafogo_real', 'Foto_1.jpg')), filename: 'Botafogo Real Foto 1.jpg')
...
botafogo_lima.photo.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'apartments', 'botafogo_lima', 'Foto_1.jpg')), filename: 'Botafogo Lima Foto 1.jpg')
