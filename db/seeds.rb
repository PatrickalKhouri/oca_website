...
copa_paranhos.photos.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'apartments', 'copa_paranhos', 'Foto_4.jpg')), filename: 'Copa Paranhos Foto 4.jpg')
copa_paranhos.photos.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'apartments', 'copa_paranhos', 'Foto_5.jpg')), filename: 'Copa Paranhos Foto 5.jpg')
